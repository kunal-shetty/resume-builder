...
const templates = [
  {
    id: 1,
    name: "Neon Cyber",
    description: "Futuristic Resume with neon effects and cyberpunk aesthetics",
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-300">Choose from our collection of stunning Resume templates</p>
            </div>
            <Link href="/builder">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Create your own custom Resume from scratch with our powerful builder
          </p>
          <Link href="/builder">
            <Button
              size="lg"
